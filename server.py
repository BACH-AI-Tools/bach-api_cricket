...
if API_KEY:
    ...
    default_headers["X-RapidAPI-Host"] = "api-cricket.p.rapidapi.com"
else:
...
client = httpx.AsyncClient(
    base_url="https://api-cricket.p.rapidapi.com", 
    timeout=30.0
)
...
async def _add_rapidapi_headers(method, url, **kwargs):
    ...
    if API_KEY:
        ...
        kwargs['headers']['X-RapidAPI-Host'] = "api-cricket.p.rapidapi.com"
    else:
...
def main():
    """主入口点"""
    print(f"🚀 启动 Api Cricket MCP 服务器")
    print(f"📦 版本: {__tag__}")
