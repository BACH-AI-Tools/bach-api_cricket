...
這是一個使用 [FastMCP](https://fastmcp.wiki) 自動生成的 MCP 伺服器，用於存取 Api Cricket API。

- **PyPI 套件名**: `bach-api_cricket`
- **版本**: 1.0.0
- **傳輸協定**: stdio
...
**注意**: 請將 `E:\path\to\api_cricket\server.py` 替換為實際的伺服器檔案路徑。
